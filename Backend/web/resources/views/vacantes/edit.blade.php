...
<div class="p-6 max-w-3xl">
    ...
    <div class="flex items-center gap-3 mb-8">
        <a href="{{ route('vacantes.index') }}" class="text-gray-400 hover:text-blue transition">
            ← Volver
        </a>
        <div>
            <h1 class="text-2xl font-bold text-black">Editar Vacante</h1>
            <p class="text-gray-700 text-sm mt-1">{{ $vacante['titulo'] }}</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('vacantes.update', $vacante['id_vacante']) }}">
        ...
        <div class="bg-blue-700 border border-blue-600 rounded-xl p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="descripcion" rows="4"
                    class="w-full bg-white border border-gray-600 text-black text-sm rounded-lg px-4 py-3 focus:outline-none focus:border-red-500">{{ old('descripcion', $vacante['descripcion']) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="id_departamento"
                        class="w-full bg-white border-gray-600 text-black text-sm rounded-lg px-4 py-3 focus:outline-none focus:border-red-500">
